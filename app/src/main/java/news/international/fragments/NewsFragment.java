...
public class NewsFragment extends Fragment implements View.OnClickListener {
    ...
    public void getLatestNews() {
        ...
        ((MyApplication)getApplicationContext()).apiService.getLatestNews( ).subscribeOn(Schedulers.newThread())
                        ...
                        if(_newsModel.getNews()!=null&&getActivity()!=null&& ((MainActivity)getActivity()).isActivityRunning) {
                            getActivity().runOnUiThread(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    adapter = new NewsAdapter(NewsScreenType.LatestNews,getActivity(),newsModel);
                            ...
                            getActivity().runOnUiThread(new Runnable() {
                                ...
                                public void run() {
                                    if (newsModel == null) {
                                        ...
                                        ((TextView) view.findViewById(R.id.textview_error)).setText(getString(R.string.interneterror));
                                    }
